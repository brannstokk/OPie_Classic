...
local K = V and {"Abilities", "Also use items with the same name", "Custom Macro", "Equipment Set", "Equipment sets", "Ground Mount", "Item", "Items", "Macro", "Macros", "Miscellaneous", "New Macro", "Only show when equipped", "Pet Ability", "Pet abilities", "Raid Marker", "Raid markers", "Show a placeholder when unavailable", "Spell"}
